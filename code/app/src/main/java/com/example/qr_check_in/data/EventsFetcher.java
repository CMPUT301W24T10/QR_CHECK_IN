...
public class EventsFetcher {
     ...
     */
    public void fetchEvents(final OnEventsReceivedListener listener) {
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            listener.onEventsReceived(eventDetailsList);
                        } else {
                            Log.d("EventsFetcher", "Error getting documents: ", task.getException());
    ...
    public interface OnEventsReceivedListener {
         ...
         */
        void onEventsReceived(List<EventDetails> eventDetailsList);
